    ...
    <section id="what-i-build" className="section border-t border-ink-800/60 bg-ink-900/40">
      <div className="container-px mx-auto max-w-7xl">
        <Reveal className="max-w-2xl">
          ...
          <h2 className="h2 mt-3">Six kinds of product work.</h2>
        </Reveal>
          ...
          {items.map((item, i) => (
            <Reveal key={item.title} delay={i * 0.05}>
              <div className="card group relative h-full overflow-hidden p-7 transition hover:border-accent-500/50">
                ...
                <div className="flex h-11 w-11 items-center justify-center rounded-sm border border-ink-700 bg-ink-900 text-accent-400 transition group-hover:border-accent-500/50 group-hover:bg-accent-500/10">
